...
//    EvmFaucetLocators FaucetObject= new EvmFaucetLocators();
    ...
    public void Dashboardtesting() throws InterruptedException {
        test = extent.createTest("Dashboard Testing");
        ...
        try {
            ...
            test.log(Status.FAIL, "Dashboard did not load properly: " + e.getMessage());
        }
    }

    @Test(priority = 2)
    public void Blocktesting() throws InterruptedException {
        test = extent.createTest("Block Testing");
        WebDriverWait wait = new WebDriverWait(BaseClass.getDriver()
                , Duration.ofSeconds(10));
        try {
        ...
        System.out.println("---------Block testing Completed---------");
            test.log(Status.PASS, "Block testing Completed");
    } catch (Exception e) {
            test.log(Status.FAIL,"Block testing failed");
        }
    }

    @Test(priority = 3)
    public void Transactiontesting() throws InterruptedException {
        test=extent.createTest("Transaction Testing");
            WebDriverWait wait = new WebDriverWait(BaseClass.getDriver(), Duration.ofSeconds(10));
        try {
            ...
            test.log(Status.PASS, "Transaction testing Completed");
        } catch (Exception e) {
            test.log(Status.FAIL,"Transaction testing failed");
        }
    }
    ...
    public void SearchTesting() throws InterruptedException {
        ...
        try {
            ...
            test.log(Status.PASS,"Search testing Completed");
        }catch (Exception e){
            test.log(Status.FAIL,"Search testing Failed");
        }
    }
    ...
    public void ContractListingTesting() throws InterruptedException {
        test=extent.createTest("Contract Listing Testing");
            WebDriverWait wait = new WebDriverWait(BaseClass.getDriver(), Duration.ofSeconds(10));
        try{
            ...
            Thread.sleep(5000);
            ContractOptionOnSideBar.click();
            test.log(Status.PASS,"Contract Listing completed");
        } catch (Exception e) {
            test.log(Status.FAIL,"Contract Listing failed");
        }
    }
    ...
    public void TopTransferTesting() throws  InterruptedException {
        test = extent.createTest("Top transfer testing");
        ...
        try {
            ...
            //Click on Contract option on Token Detail page.
            ...
            TopTransferOptionOnSidebar.click();
            test.log(Status.PASS, "Top token testing completed");
        } catch (Exception e) {
            test.log(Status.FAIL, "Top token testing completed");
        }
    }
    ...
    public void TokenTransferTesting() throws InterruptedException {
        test = extent.createTest("Token transfer testing");
        WebDriverWait wait = new WebDriverWait(BaseClass.getDriver(), Duration.ofSeconds(10));
        try {
            //switch to token option on sidebar
            WebElement TokenOptionOnSidebar = TokenOneObjects.TokenOnSidebar();
            ...
            TokenTransferButtonOnSidebar.click();
            test.log(Status.PASS, "Token transfer testing completed");
        } catch (Exception e) {
            test.log(Status.FAIL, "Token transfer testing failed");
        }
    }

    @Test(priority=8)
    public void NodeTesting() throws InterruptedException {
        test = extent.createTest("node testing");
        WebDriverWait wait = new WebDriverWait(BaseClass.getDriver(), Duration.ofSeconds(10));
        try {
            ...
            Thread.sleep(3000);
            test.log(Status.PASS, "Node testing completed");
        } catch (Exception e) {
            test.log(Status.FAIL, "Node testing failed");
        }
    }
