...
public class UtxoTesting extends BaseClass {
   ...
   // UtxoFaucetLocators UtxoFaucetObjects= new UtxoFaucetLocators();
    ...
    public void UtxoSwitching() throws InterruptedException {
        test = extent.createTest("Utxo Switching");
        ...
        try {
            ...
            test.log(Status.PASS, "Utxo Switching Completed");
        } catch (Exception e) {
            test.log(Status.FAIL, "Utxo Switching Completed");
        }
    }

    @Test(priority =2)
    public void UtxoDashboardTesting() throws InterruptedException {
        test = extent.createTest("Utxo Dashboard Testing");
        WebDriverWait wait = new WebDriverWait(BaseClass.getDriver(), Duration.ofSeconds(10));
        try {
            Thread.sleep(5000);
            ...
            test.log(Status.PASS, "Utxo Dashboard Testing Completed");
        } catch (Exception e) {
            test.log(Status.FAIL, "Utxo Dashboard Testing Failed");
        }
    }

    @Test(priority = 3)
    public void UtxoBlockTesting() throws InterruptedException {
        test = extent.createTest("Utxo Block Testing");
        WebDriverWait wait = new WebDriverWait(BaseClass.getDriver(), Duration.ofSeconds(10));
        try {
            ...
            BaseClass.getDriver()
                    .navigate().back();
            test.log(Status.PASS, "Utxo Block Testing completed");
        } catch (Exception e) {
            test.log(Status.FAIL, "Utxo Block Testing failed");
        }
    }

    @Test(priority = 4)
    public void UtxoTransactiontesting() throws InterruptedException {
        test= extent.createTest("Utxo Transaction testing");
        ...
        Thread.sleep(3000);
        test.log(Status.PASS,"Utxo Transaction testing completed");
    } catch (Exception e) {
            test.log(Status.FAIL,"Utxo Transaction testing failed");
        }
    }

    @Test(priority = 5)
    public  void UtxoNodeTesting() throws InterruptedException {
        test = extent.createTest("Utxo Node Testing");
        WebDriverWait wait = new WebDriverWait(BaseClass.getDriver(), Duration.ofSeconds(5));
        try {
            ...
            Thread.sleep(3000);
            test.log(Status.PASS, "Utxo Node Testing completed");
        } catch (Exception e) {
            test.log(Status.FAIL, "Utxo Node Testing failed");
        }
    }

    @Test(priority = 6)
    public void UtxoSearchBarTesting() throws InterruptedException {
        test = extent.createTest("Utxo SearchBar Testing");
        WebDriverWait wait = new WebDriverWait(BaseClass.getDriver(), Duration.ofSeconds(10));
        try {
            ...
            test.log(Status.PASS, "Utxo Search Testing Completed");
        } catch (Exception e) {
            test.log(Status.FAIL, "Utxo Search Testing Failed");
        }
    }
